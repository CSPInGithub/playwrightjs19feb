...
//     await page.locator('').fill('standard_user')
//     await page.locator('').fill('secret_sauce')
...
//     try {
//         await expect.soft(page.locator('button#add-to-cart-sauce-labs-backpack')).toHaveText("Add to cart1");
//     } catch (error) {
